...
function StatCard({ value, label, delay = 0 }: StatCardProps) {
  return (
    <motion.div
      ...
      className="rounded-2xl p-6 md:p-8 text-center bg-white/20 shadow-lg"
    >
      <div className="font-display text-[clamp(2.5rem,5vw,4rem)] font-light text-white mb-2 tracking-tight">
        <CountUp value={value} />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div>
            ...
            <motion.h2
              ...
              className="font-display text-[clamp(2rem,4vw,3.5rem)] font-normal leading-tight"
            >
              {t("title")}{" "}
